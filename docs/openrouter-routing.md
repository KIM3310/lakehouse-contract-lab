...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `openai/gpt-5.4-mini` | Data contract explanation, migration notes, and quality exception summaries. |
...
OPENROUTER_HTTP_REFERER=https://lakehouse-contract-lab.pages.dev
OPENROUTER_APP_TITLE=lakehouse-contract-lab
```
