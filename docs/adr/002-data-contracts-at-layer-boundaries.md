...
- **Auditability**: The machine-readable quality artifact includes the full rule set, allowing data platform reviewers to inspect the quality contract without reading Spark code.
