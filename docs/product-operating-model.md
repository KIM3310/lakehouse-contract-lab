...
Spark + Delta medallion proof with quality gates and contract surfaces
...
| Area | Position |
| --- | --- |
| Target reviewer | Data teams modernizing batch quality and contracts |
| Service wedge | Data contract starter pack and migration advisory |
| Review signal | Spark, data contracts, quality gates, warehouse export boundaries |
