# Service Architecture - lakehouse-contract-lab
...
- **Lane:** Data contracts and quality gates
- **Primary buyer:** Data platform teams improving pipeline quality and migration readiness
- **First motion:** Data-contract assessment using sample or redacted datasets

## Recommended Architecture

Docs/report surface, Python/Spark jobs in CI or buyer data platform, artifact storage for rejected-row reports and contract outputs.
...
- GitHub Pages
- buyer Spark/Databricks/Snowflake environment later
- R2/S3 artifact storage
- CI runner

## Information Needed From Account Owner

- warehouse credentials only inside buyer environment
- artifact storage token

## Cost and Risk Controls

- sample datasets first
- contract versioning
- no raw buyer rows in public artifacts
