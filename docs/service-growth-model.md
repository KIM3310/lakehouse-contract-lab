# Service Growth Model - lakehouse-contract-lab
...
| Field | Decision |
|---|---|
| Service type | Data contracts and quality gates |
| Primary reader or buyer | Data platform teams improving pipeline quality and migration readiness. |
| Wedge | Data-contract assessment using sample or redacted datasets. |
